# Generated by Django 5.0.7 on 2024-11-28 07:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_6am_6pm_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('time_6am_12mn_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('time_12hrs_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('time_24hrs_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=255)),
                ('capacity', models.PositiveIntegerField()),
                ('time_3hrs_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('time_6hrs_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('time_12hrs_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('time_24hrs_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
            ],
        ),
