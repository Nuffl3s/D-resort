...
from api.views import UpdatePayrollView, TotalUnitsView, ReservationView, AdminAccountsView, CustomerAccountRegisterView, CustomerLoginView, CustomerDetailsView, ChangePasswordView, CalendarView
...
urlpatterns = [
    ...
    path('api/calendar/', CalendarView.as_view(), name='calendar-view'),
