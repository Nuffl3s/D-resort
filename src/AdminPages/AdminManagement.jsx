                            ...
                            <div className="justify-between border-b mb-4 pb-3">
                                ...
                                <div className="w-full flex justify-between">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        <div className="flex bg-white items-center p-2 rounded-md border dark:border-gray-400 dark:bg-[#374151]">
                                            <img 
                                            ...
                                            />
                                            <input
                                                className="bg-white outline-none ml-1 block dark:bg-[#374151] dark:text-[#e7e6e6] dark:placeholder:text-gray-200"
                                                type="text"
                                                placeholder="Search..."
                                                value={searchTerm} 
