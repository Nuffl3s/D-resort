...
function AccountInfoPage() {
    ...
    const handleBookAgain = (reservation) => {
        ...
        // Set a default value for unit_type if it's missing
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-5">
                ...
                <div className="flex items-center space-x-4 mb-6">
                    <label className="text-lg font-semibold">Sort Reservations:</label>
                    <select
                        value={sortOption}
                    ...
                    <label className="text-lg font-semibold">Unit Type:</label>
                    <select
                        value={unitType}
                ...
                {groupedLogs.length > 0 ? (
                        groupedLogs.map((reservationGroup, index) => (
                            ...
                            >
                                ...
                                />
                                <div className="p-4">
                                    <h3 className="text-xl font-semibold mb-2">{reservationGroup.unit_name}</h3>
                                    <p className="text-gray-600 mb-1">
                                        <strong>Reservations:</strong> {reservationGroup.reservations.length} times
                                    </p>
                                    <p className="text-gray-600 mb-1">
                                        <strong>Last Reserved:</strong> {reservationGroup.reservations[0].date_of_reservation}
                                    </p>
                                    ...
                                    <div className="flex space-x-4 mt-4">
                                        <button
                                            onClick={() => handleBookAgain(reservationGroup.reservations[0])}
                                            className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md shadow"
                                        >
                                            Book Again
                                        </button>
                                        <button
                                            onClick={() => handleCheckAvailability(reservationGroup.unit_name)}
